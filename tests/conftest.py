"""Root test configuration — shared fixtures for all tests."""
...
def xgb_model_path(tmp_path):
    ...
    for i in range(2):
        trees.append({
            "tree_param": {"num_nodes": "3", "size_leaf_vector": "0", "num_feature": "4"},
            "id": i, "num_nodes": 3,
    ...
    data = {
        "learner": {
            "learner_model_param": {"num_feature": "4", "num_class": "0", "base_score": "5E-1"},
            "gradient_booster": {
                "name": "gbtree",
                "model": {
                    "gbtree_model_param": {"num_trees": "2", "size_leaf_vector": "0"},
                    "trees": trees, "tree_info": [0, 0],
                },
            },
